...
public partial class admin_lstContacts : System.Web.UI.Page
{
    ...
    {
        this._message.Text = "Contact was Updated";
    }
    protected void GridView1_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
        this._message.Text = "Editing of contact was cancelled.";
    }
    protected void GridView1_RowDeleted(object sender, GridViewDeletedEventArgs e)
    {
        this._message.Text = "Contact was Deleted";
    }
    protected void _submit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            if (Page.IsValid)
            {
                ...
                using (SqlCommand cmd = new SqlCommand("[lstContactsInsert]", conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@personID", this._person1.SelectedValue);
                    cmd.Parameters.AddWithValue("@companyID", this._company1.SelectedValue);
                    cmd.Parameters.AddWithValue("@jobTitle", this._jobTitle1.Text);
                    cmd.Parameters.AddWithValue("@phone", this._phone1.Text);
                    ...
                    try
                    {
                        ...
                        if (intResponse == 0)
                        {
                            this._message.Text = "Contact Information already existed - Not added";
                        }
                        else
                        {
                            this._message.Text = "New contact information was added";
                        }
                    ...
                    {
                        this._message.Text = "Error on inserting into the lstContacts Table " + ex.Message;
                    }
                }
            }
    ...
    protected void _addStart_Click(object sender, EventArgs e)
    {
        ...
        //clear textboxes
        this._person1.SelectedIndex = 0;
        this._jobTitle1.Text = "";
        this._company1.SelectedIndex = 0;
        this._phone1.Text = "";
